package com.github.shareme.gwsblastfurnace.library.list;
...
import com.github.shareme.gwsblastfurnace.library.maybe.Maybe;
...
//        });
    ...
    public GWSPair<ListM<A>, ListM<A>> partition(final Function.F1<? super A, Boolean> func) {
    ...
    @Override
    public boolean addAll(int location, @NonNull Collection<? extends A> collection) {
